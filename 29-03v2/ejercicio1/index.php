               ...
               <main class="flex w-full flex-1 flex-col text-center">
                  <div class="relative min-h-max">
                     <div class="absolute mt-24 sm:mt-36 w-full flex flex-col items-center">
                        <div class="max-w-7xl mx-auto px-4 md:px-6">
                           <h1 class="text-2xl sm:text-4xl md:text-5xl text-white font-bold mb-3">Encuentra tu discoteca en todo lugar</h1>
                           <h2 class="text-xs sm:text-lg md:text-xl px-6 text-white font-normal">
                              Reserva en
                              <strong>
                                 <!-- -->
                                 +xxxx
                              ...
                              discotecas en Bogotá en un solo lugar
                           </h2>
                        </div>
                              ...
                              <button onclick="document.getElementById('id01').style.display='block'" style="width:auto;" id="filtros" class="button-34 shadow-xl"><i class="fa fa-filter" style="font-size:24px"></i></button>
                                 ...
                                 <div class="absolute inset-y-0 right-0 pr-2 flex items-center">
                                    <button id="botonBuscar" role="link" class="flex flex-row bg-basePurple px-4 md:px-6 rounded-full h-[75%] items-center cursor-pointer" onclick="OnclickBuscar()">
                                       <span class="text-white text-xs md:text-sm font-normal">Buscar</span>
                                       <svg class="h-4 w-4 fill-white ml-2" fill="currentColor" viewBox="0 0 20 20">
                     ...
                     <div class="h-[360px] sm:h-[460px] relative -z-10">
                        <div class="absolute w-full h-full bg-gradient-to-t from-black/70 to-black/10"></div>
                        <div class="w-full h-full">
                           <picture>
                              <img src="./-buscarDiscotecas/index_files/utils/test1.jpg" class="w-full h-full object-cover" alt="Banner">
                           </picture>
                        </div>
                        <div class="absolute bottom-0 z-10 w-full ">
                           <img src="./-buscarDiscotecas/index_files/utils/curva_home_2.png" class="w-full h-[15px] md:h-[25px] -mb-[1px]" alt="">
                        </div>
                     </div>
                  </div>
            <!-- SECCION DE BUSQUEDA -->
                  ...
                  <div class="max-w-7xl mx-auto px-4 md:px-6">
                     <div class="grid grid-cols-1 lg:grid-cols-12 md:gap-4 lg:gap-8 pb-4 md:py-4 lg:py-8 transition-colors duration-150">
                        ...
                        <div class="col-span-1 lg:col-span-3">
                           <div class="grid md:grid-rows-3 md:grid-cols-1 md:grid-flow-col">
                              <div class="font-bold text-basePurple w-full py-3 md:py-0 md:pb-4">Nosotros</div>
                        ...
                        <div class="col-span-1 lg:col-span-4 flex flex-col items-start">
                           ...
                           <span class="py-3 md:py-0 md:pb-4">
                              <a class="text-accent-9 hover:text-accent-6 transition ease-in-out duration-150 flex">
                                 <span>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M9.01069 5.97055C9.00482 5.77327 9.05802 5.57873 9.16347 5.41189C9.26891 5.24505 9.42179 5.11352 9.6025 5.03416C9.78322 4.9548 9.98351 4.93124 10.1777 4.96649C10.3719 5.00175 10.5511 5.09421 10.6924 5.23202C10.8337 5.36984 10.9306 5.54672 10.9707 5.73997C11.0107 5.93323 10.9922 6.13405 10.9173 6.31668C10.8425 6.49931 10.7148 6.65542 10.5506 6.76498C10.3865 6.87454 10.1933 6.93256 9.99596 6.9316C9.86776 6.93469 9.74025 6.91212 9.6209 6.86522C9.50156 6.81832 9.39279 6.74803 9.301 6.6585C9.20921 6.56896 9.13624 6.46198 9.08639 6.34384C9.03653 6.2257 9.0108 6.09878 9.01069 5.97055ZM9.07806 7.68739H10.9139V14.6158H9.07806V7.68739Z" fill="black"></path>
                                       <path d="M10 1.34632C12.0012 1.34704 13.9403 2.0416 15.4868 3.31164C17.0334 4.58169 18.0917 6.34866 18.4816 8.31152C18.8715 10.2744 18.5688 12.3117 17.625 14.0764C16.6812 15.8411 15.1548 17.224 13.3058 17.9895C11.4568 18.755 9.39957 18.8557 7.48461 18.2745C5.56965 17.6934 3.91543 16.4662 2.80377 14.8022C1.69211 13.1381 1.19178 11.1401 1.38802 9.14856C1.58426 7.15699 2.46494 5.29507 3.88 3.88C4.68188 3.07396 5.63568 2.43499 6.68619 2.00008C7.73669 1.56517 8.86304 1.34296 10 1.34632ZM10 0C8.02219 0 6.08879 0.586489 4.4443 1.6853C2.79981 2.78412 1.51809 4.3459 0.761209 6.17317C0.00433282 8.00043 -0.193701 10.0111 0.192152 11.9509C0.578004 13.8907 1.53041 15.6725 2.92894 17.0711C4.32746 18.4696 6.10929 19.422 8.0491 19.8079C9.98891 20.1937 11.9996 19.9957 13.8268 19.2388C15.6541 18.4819 17.2159 17.2002 18.3147 15.5557C19.4135 13.9112 20 11.9778 20 10C20 7.34784 18.9464 4.8043 17.0711 2.92893C15.1957 1.05357 12.6522 0 10 0Z" fill="black"></path>
                                    </svg>
                                 </span>
                                 <span class="ml-5 text-sm">Términos y condiciones</span>
                              </a>
                           </span>
                           <span class="py-3 md:py-0 md:pb-4">
                              <a target="_blank" class="text-accent-9 hover:text-accent-6 transition ease-in-out duration-150 flex">
                                 ...
                                 <span class="ml-5 text-sm">Autorización de tratamiento de datos personales</span>
                              </a>
                           </span>
                        </div>
                        <div class="col-span-1 lg:col-span-3">
                           <div class="font-bold text-basePurple w-full py-3 md:py-0 md:pb-4">Síguenos</div>
                           <div class="grid grid-rows-1 grid-cols-2 max-w-fit">
                              <span class="py-3 md:py-0 md:pb-4">
                                 <a target="_blank" rel="noopener noreferrer" class="text-accent-9 hover:text-accent-6 transition ease-in-out duration-150 flex">
                                    <span>
                                       <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M16 1H6C3.23858 1 1 3.23858 1 6V16C1 18.7614 3.23858 21 6 21H16C18.7614 21 21 18.7614 21 16V6C21 3.23858 18.7614 1 16 1Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                          <path d="M15.0002 10.3701C15.1236 11.2023 14.9815 12.0523 14.594 12.7991C14.2065 13.5459 13.5933 14.1515 12.8418 14.5297C12.0903 14.908 11.2386 15.0397 10.408 14.906C9.57732 14.7723 8.80996 14.3801 8.21503 13.7852C7.62011 13.1903 7.22793 12.4229 7.09426 11.5923C6.9606 10.7616 7.09226 9.90995 7.47052 9.15843C7.84878 8.40691 8.45438 7.7938 9.20118 7.4063C9.94798 7.0188 10.7979 6.87665 11.6302 7.00006C12.4791 7.12594 13.265 7.52152 13.8719 8.12836C14.4787 8.73521 14.8743 9.52113 15.0002 10.3701Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                          <path d="M16.5 5.5H16.51" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                       </svg>
                                    </span>
                                 ...
                                 <a target="_blank" rel="noopener noreferrer" class="text-accent-9 hover:text-accent-6 transition ease-in-out duration-150 flex">
                                    <span>
                                       <svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M15 7C16.5913 7 18.1174 7.63214 19.2426 8.75736C20.3679 9.88258 21 11.4087 21 13V20H17V13C17 12.4696 16.7893 11.9609 16.4142 11.5858C16.0391 11.2107 15.5304 11 15 11C14.4696 11 13.9609 11.2107 13.5858 11.5858C13.2107 11.9609 13 12.4696 13 13V20H9V13C9 11.4087 9.63214 9.88258 10.7574 8.75736C11.8826 7.63214 13.4087 7 15 7V7Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                          <path d="M5 8H1V20H5V8Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                          <path d="M3 5C4.10457 5 5 4.10457 5 3C5 1.89543 4.10457 1 3 1C1.89543 1 1 1.89543 1 3C1 4.10457 1.89543 5 3 5Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                       </svg>
                                    </span>
                                    <span class="ml-5"></span>
                                 </a>
